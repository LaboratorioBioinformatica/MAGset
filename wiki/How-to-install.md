...
`curl -OL https://github.com/LaboratorioBioinformatica/magset/releases/download/1.5.1/run-magset.sh`
<br/> or <br/>
`wget https://github.com/LaboratorioBioinformatica/magset/releases/download/1.5.1/run-magset.sh`
